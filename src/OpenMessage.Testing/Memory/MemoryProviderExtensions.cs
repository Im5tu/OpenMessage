...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class MemoryProviderExtensions
    {
        ...
        public static IServiceCollection AddAwaitableMemoryDispatcher<T>(this IServiceCollection services)
        {
            return services.AddSingleton<IDispatcher<T>, AwaitableMemoryDispatcher<T>>();
        }
    }
}