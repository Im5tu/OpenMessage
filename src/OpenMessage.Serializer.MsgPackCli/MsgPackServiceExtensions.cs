...
namespace OpenMessage.Serializer.MsgPackCli
{
    ...
    public static class MsgPackSerializerServiceExtensions
    {
        ...
        public static IMessagingBuilder ConfigureMsgPack(this IMessagingBuilder messagingBuilder)
        {
            return messagingBuilder.ConfigureMsgPackDeserializer().ConfigureMsgPackSerializer();
        }
        ...
        public static IMessagingBuilder ConfigureMsgPackSerializer(this IMessagingBuilder messagingBuilder)
        {
            ...
            messagingBuilder.Services.AddSerialization().AddSingleton<ISerializer>(sp => sp.GetRequiredService<MsgPackSerializer>());
        ...
        {
            messagingBuilder.Services.TryAddSingleton<MsgPackSerializer>();
            messagingBuilder.Services.AddSerialization().AddSingleton<IDeserializer>(sp => sp.GetRequiredService<MsgPackSerializer>());
            return messagingBuilder;
        }
    }
}